    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 flex">
      ...
      <aside className="w-64 bg-white dark:bg-slate-800 border-r border-slate-200 dark:border-slate-700 hidden lg:flex flex-col h-screen sticky top-0">
        ...
        <nav className="flex-1 p-4 space-y-2 mt-4">
          ...
          <Link href="/admin/attendance" className="flex items-center space-x-3 w-full p-3 bg-teal-50 dark:bg-teal-900/30 text-teal-700 dark:text-teal-400 rounded-xl font-bold transition-all text-left">
