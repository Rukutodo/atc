...
import { Book, Globe, Home, CheckCircle2 } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <motion.div
              ...
              className="p-8 rounded-3xl bg-white border border-slate-100 card-hover"
            >
              ...
              <ul className="space-y-3">
                {service.features.map((feature) => (
                  <li key={feature} className="flex items-center space-x-2 text-slate-700">
