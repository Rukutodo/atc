        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            >
              ...
              <span className="text-teal-600">With Us Today</span>
            </motion.h2>
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h4 className="font-bold text-slate-900">Personalized Counseling</h4>
                  <p className="text-sm text-slate-500">Free first session to understand student's needs.</p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                <div className="bg-teal-50 p-3 rounded-full">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500">Transparent pricing for all tutoring packages.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-white p-8 sm:p-10 rounded-3xl shadow-2xl shadow-slate-100 border border-slate-100"
          >
            {submitStatus === 'success' ? (
              <div className="text-center py-12">
                <div className="bg-teal-100 h-20 w-20 rounded-full flex items-center justify-center mx-auto mb-6">
                  <CheckCircle className="h-10 w-10 text-teal-600" />
                </div>
                <h3 className="text-2xl font-bold text-slate-900 mb-2">Message Sent!</h3>
                <p className="text-slate-600 mb-8">Thank you for reaching out. We'll contact you shortly.</p>
                <button
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label className="block text-sm font-bold text-slate-700 mb-2">Grade / Service</label>
                    <select
                      {...register('grade')}
                      className={`w-full px-4 py-3 rounded-xl border ${
                        errors.grade ? 'border-red-500' : 'border-slate-200'
                      } focus:outline-none focus:ring-2 focus:ring-teal-500 transition-all bg-white`}
                    >
                ...
                <button
                  ...
                  className="w-full bg-teal-600 text-white py-4 rounded-xl font-bold text-lg hover:bg-teal-700 transition-all shadow-xl shadow-teal-100 flex items-center justify-center disabled:opacity-70"
                >
                  {isSubmitting ? (
                    <>
